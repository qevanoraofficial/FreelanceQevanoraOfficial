  ...
  return (
    <article className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-8">
      ...
      {product.category === "pterodactyl-panel" ? (
        ...
        <>
          <div className="mt-8 flex flex-col items-start justify-between gap-3 border-y border-gray-200 py-5 dark:border-gray-800 sm:flex-row sm:items-center sm:gap-4">
